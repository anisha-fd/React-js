...
// import '../../public/assets/images/banner-01.jpg'

function Home() {
  return (
    <div>
    {/* <img src={process.env.PUBLIC_URL + '../../public/assets/images/banner-01.jpg'}></img> */}
    {/* <img src={process.env.PUBLIC_URL + '../../public/assets/images/banner-02.jpg'}></img> */}
      ...
      <div className="row">
        <div className="col-lg-4">
          <div className="left-image">
            <img src="assets/images/featured.jpg"  />
            <a href="property-details.html"><img src="assets/images/featured-icon.png"  style={{maxWidth: 60, padding: 0}} /></a>
          </div>
        </div>
        ...
        <div className="col-lg-3">
          <div className="info-table">
            <ul>
              <li>
                <img src="assets/images/info-icon-01.png"  style={{maxWidth: 52}} />
                <h4>250 m2<br /><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-02.png"  style={{maxWidth: 52}} />
                <h4>Contract<br /><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-03.png"  style={{maxWidth: 52}} />
                <h4>Payment<br /><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-04.png"  style={{maxWidth: 52}} />
      ...
      <div className="row">
        <div className="col-lg-10 offset-lg-1">
          <div className="video-frame">
            <img src="assets/images/video-frame.jpg"  />
              ...
              <div className="tab-content" id="myTabContent">
                <div className="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/images/deal-01.jpg"  />
                    </div>
                    <div className="col-lg-3">
                ...
                <div className="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/images/deal-02.jpg"  />
                    </div>
                    <div className="col-lg-3">
                ...
                <div className="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/images/deal-03.jpg"  />
                    </div>
                    <div className="col-lg-3">
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-01.jpg"  /></a>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-02.jpg"  /></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-03.jpg"  /></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-04.jpg"  /></a>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-05.jpg"  /></a>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/images/property-06.jpg"  /></a>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="item phone">
                <img src="assets/images/phone-icon.png"  style={{maxWidth: 52}} />
                <h6>010-020-0340<br /><span>Phone Number</span></h6>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="item email">
                <img src="assets/images/email-icon.png"  style={{maxWidth: 52}} />
